...
export const canonicalMappings: SofMapping[] = [
  { canonical: "NAV_EOSP", confidence: 0.7, keywords: [/e\.?o\.?s\.?p\.?/i, /end of sea passage/i, /arrival at pilot station/i, /arrival at port limits/i] },
  ...
  { canonical: "NAV_PILOT_ON_ARR", confidence: 0.8, keywords: [/pob/i, /pilot on board/i, /pilot boarded/i, /pilot embarked/i] },
  { canonical: "NAV_TUGS_MADE_FAST", confidence: 0.7, keywords: [/tugs?\s+(fast|made fast)/i, /tug lines fast/i, /tug connected/i] },
  { canonical: "NAV_FIRST_LINE", confidence: 0.7, keywords: [/first line/i, /1st line ashore/i, /spring line ashore/i] },
  { canonical: "NAV_ALL_FAST", confidence: 0.9, keywords: [/all fast/i, /all lines fast/i, /\bmoored\b/i, /berthed all fast/i, /\bf\.?w\.?e\.?\b/i, /finished with engines/i, /fast at berth/i] },
  ...
  { canonical: "CARGO_OPS_START", confidence: 0.8, keywords: [/commenced loading/i, /commenced discharging/i, /start (loading|discharge)/i, /cargo ops started/i, /commenced cargo operations/i, /using loader/i] },
  { canonical: "CARGO_OPS_STOP", confidence: 0.75, keywords: [/stopped loading/i, /stopped discharging/i, /ceased cargo/i, /suspended cargo/i, /cargo ops stopped/i] },
  { canonical: "CARGO_OPS_RESUME", confidence: 0.75, keywords: [/resumed loading/i, /resumed discharging/i, /recommenced cargo/i, /restarted cargo ops/i] },
